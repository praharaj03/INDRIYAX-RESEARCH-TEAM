...
export default function SubscribePage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-16">
            ...
            <AnimateIn key={plan.id} delay={i * 0.08}>
              <div className={`relative bg-dark-3 border ${plan.color} rounded-2xl p-6 flex flex-col h-full ${plan.id === "pro" ? "ring-1 ring-primary/20" : ""}`}>
                ...
                <div className="mb-6">
                  ...
                  {plan.id === "elite" && (
                    <p className="text-emerald-400 text-xs mt-1 font-medium">Save ₹889 vs monthly</p>
                  )}
                </div>
      ...
      {/* FAQ / note */}
      <AnimateIn>
        <div className="bg-dark-3 border border-border rounded-2xl p-8">
          <h2 className="text-white font-bold text-lg mb-6 text-center">Common Questions</h2>
